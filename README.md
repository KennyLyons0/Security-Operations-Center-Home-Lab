...
Shows KQL query output from Azure Log Analytics workspace (`LAW‑SOC‑Lab‑5000`), filtering failed login attempts (EventID 4625) and enriching with geolocation data.  
![Azure Log Analytics Query Results](images/azure-log-query.png)
### 2. Windows VM Attack Map
Displays global attack visualization from Microsoft Sentinel workbook, highlighting top sources (South Korea, Germany, U.S., South Africa, India, Belgium).  
![Windows VM Attack Map](images/attack-map.png)
